...
class ShippingQuoteController extends Controller
{
    public function store(
        ...
        CheckoutPackageBuilder $packages,
        MelhorEnvioRateAdapter $adapter,
        CheckoutShippingQuoteIssuer $issuer,
    ) {
        ...
        try {
            ...
            if ($config === null) {
                throw new DomainException('A cotação de frete não está configurada para esta loja.');
            }
