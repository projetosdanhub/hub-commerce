...
Atualizado em: 2026-09-06 — blocos operacionais de Pedidos em validação  
...
| [~] | UI-022 | P1 | Completar reembolso com cancelamento e anexos | UI-021 | Estado anterior persistido/restaurado sob lock; solicitação repetida oculta; modalidade explícita e 1–2 imagens privadas obrigatórias. Faltam idempotência financeira do cashback e homologação CI |
| [~] | UI-023 | P1 | Detalhar personalizações e cliente do pedido | UI-021 | Tag, textos e imagens agrupados por item/SKU/variante; dados ampliados do cliente. Falta migrar anexos de personalização para download privado autorizado |
| [~] | UI-024 | P1 | Exibir documentos reais de cada operação | UI-022, UI-023 | Lista unificada e autenticada para pagamento, entrega, reembolso e romaneio; preview/download e estado vazio real. Falta migração física dos anexos legados públicos |
| [~] | UI-024 | P1 | Exibir documentos reais de cada operação | UI-022, UI-023 | Lista unificada e autenticada para pagamento, entrega, reembolso e romaneio; preview/download e estado vazio real. Falta migração física dos anexos legados públicos |
| [~] | UI-026 | P1 | Detalhar valores e progresso operacional | UI-021 | Subtotal, frete, bruto, desconto registrado e líquido exibidos sem inventar origem; método real e progresso animado. Falta snapshot de descontos por origem e bandeira persistida no checkout |
