...
| [~] | APP-015 | P0 | Melhor Envio OAuth por lojista | VAULT-001, SHIP-004 | Authorization Code, state único, callback fixo e token cifrado entregues; faltam refresh automático, validação de webhook, Sandbox real e homologação de etiquetas |
