...
| Status | ID | Prioridade | Tarefa | Critério de aceite |
|---|---|---:|---|---|
| [~] | DEV-DOCKER-001 | P1 | Substituir XAMPP pelo Docker local | Compose e documentação criados para Laravel, PostgreSQL, Redis, MinIO, Mailpit, assets compilados para túnel e Vite/HMR opt-in; pendem bootstrap local e validação dos serviços |
