...
| [~] | ORD-005 | P1 | Exibir pagamento e mídia privada de personalização no pedido | SEC-009, TEN-006 | Lista exibe somente a forma de pagamento; detalhe separa gateway; mídia por item usa URL temporária autorizada e isolada por tenant |
| [~] | DEV-001 | P2 | Criar dados locais de demonstração tenant-scoped | CAT-002, ORD-005 | SQLite local possui catálogo com e sem variações/personalização e pedidos com desconto/cupom; nenhum dado de demonstração é semeado em produção |
