...
| [~] | UI-018 | P1 | Aplicar padrão canônico ao módulo Pixel | UI-005, UI-006, UI-007, UI-009 | Painel, integrações, acionadores e diálogos usam primitives, contratos reais e experiências desktop/mobile; implementação em curso |
