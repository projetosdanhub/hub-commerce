...
|---|---|---:|---|---|---|
| [x] | MEDIA-001 | P2 | Organizar logos WebP de gateways, meios de pagamento e transportadoras | — | Arquivos fora da raiz; a pasta visível `imagesadmin/` na raiz contém variantes de gateway exibidas nos cards por tema, meios de pagamento e transportadoras sem duplicação |
