...
| [~] | MKT-003 | P2 | Projetar avaliações e moderação | CRM-001 | A interface administrativa permanece indisponível na branch `ui/reviews-modernization`: o contrato legado não vincula avaliações ao tenant nem oferece autoria, produto e status auditáveis. Modelar isolamento, autorização e auditoria antes de liberar consulta ou moderação |
