                ...
                <form onSubmit={handleSave} className="max-w-4xl mx-auto space-y-8">
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <label>Inscrição estadual<input value={senderForm.inscricao_estadual || ''} maxLength={30} onChange={e=>setSenderForm({...senderForm, inscricao_estadual: e.target.value})} className="w-full rounded-xl border p-3" /></label>
                            <label>CNAE<input value={senderForm.cnae || ''} maxLength={10} onChange={e=>setSenderForm({...senderForm, cnae: e.target.value})} className="w-full rounded-xl border p-3" /></label>
