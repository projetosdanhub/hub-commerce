...
const Icons = {
    ...
    Pixels: ({ className }) => <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>,
    ...
    const menuGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Pixels & Rastreio', path: '/admin/pixels', icon: Icons.Pixels }, 
            ]
        },
        {
            title: "Logística",
