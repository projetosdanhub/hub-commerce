// ============================================================================
// FICHEIRO: resources/js/Modulos/Admin/Pixels/Acionadores/DataLayerTriggers.jsx
// Orquestrador da aba "Data Layer" — Eventos Nativos + Acionadores + Editor
// ============================================================================
import React from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { tabTransition } from '../Shared/PixelConstants';
import EventosNativos from './NativeEvents';
import AcionadoresPersonalizados from './CustomTriggers';
import EditorDeRegra from './RuleBuilder';

const DataLayerTriggers = ({
    // View control
    triggerView,
    setTriggerView,
    // Eventos Nativos
...
export default DataLayerTriggers;