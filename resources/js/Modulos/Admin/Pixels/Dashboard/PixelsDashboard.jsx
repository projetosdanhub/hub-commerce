// ============================================================================
// FICHEIRO: resources/js/Modulos/Admin/Pixels/Painel/PixelsDashboard.jsx
...
import { tabTransition, standardEvents, buildBaseCardProps } from '../Shared/PixelConstants';
import { SafeTooltip } from '../Shared/PixelUI';
import { ConfigMetricsModal, DateFilterPopup } from '../Shared/PixelModals';

const PixelsDashboard = ({
    dashboardData,
    dashboardConfig,
    setDashboardConfig,
    credenciais,
...
export default PixelsDashboard;