...
import './storefrontBuilder.css'; // O nosso CSS puro do construtor

// Sub-módulos
import BarraLateral from './Sidebar/Sidebar';
import AreaDeVisualizacao from './Preview/PreviewPanel';
import InspetorDePropriedades from './Inspector/PropertyInspector';

const StorefrontBuilderPage = () => {
