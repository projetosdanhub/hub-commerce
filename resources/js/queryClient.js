...
export const adminQueryKeys = {
  ...
  products: (params = {}) => ['admin', tenantScope(), 'products', params],
  productCategories: () => ['admin', tenantScope(), 'products', 'categories'],
  productAudits: () => ['admin', tenantScope(), 'products', 'audits'],
};
