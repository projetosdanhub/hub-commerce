...
- Implementação visual: .ai/rules/06-design-system.md, .ai/rules/12-ui-ux-seo-and-mobile.md, .ai/rules/13-ui-agent-playbook.md, .ai/rules/14-operational-admin-interactions.md e tokens em resources/css/tokens.css.
